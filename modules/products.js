...
class Product {
    /* 
        ...
        @throws Error
    */
    constructor(strId, strCategory, strTitle, strDescription, strSrc, strPrice) {
        var errors = {};
        ...
        if (null == strPrice || !size(strPrice) || !isString(strPrice)) {
            errors['\tString Price'] = ' is required';
        }
...
let ProductManager = (function(){
	...
	return function(noun, verb) {
        ...
        if (Object.keys(errors).length > 0) {
            ...
            // Edit a Product - find it by id, title or descripton.
            // @param Product noun
            // @param String verb
            if ((noun instanceof Product) && verb === 'edit') {
                ...
                for (var i = 0; i < products['container'].length; i++) {
                    ...
                    if (product.id.toString().trim().toLowerCase() === noun.getId().toString().toLowerCase() ||
                        product.title.trim().toLowerCase() === noun.getTitle().trim().toLowerCase() ||
                        product.description.trim().toLowerCase() === noun.getDescription().trim().toLowerCase()) {
                            eObj = product;
                            break;
                        }
                }
                ...
                if (null !== eObj) {
                    ...
                    eObj.price = noun.getPrice();
                    return true;
                }
                return false;
            }    
            
            // Remove a Product by id, title or description.
            // @param String noun
            // @param String verb
            ...
            // Find a single Product by id, title or category.
            // @param String noun
            // @param String verb
            // @return Product 
